...
const Log = () => {
  ...
  return (
    <div className='flex h-screen mx-5 my-5'>
        <div className='w-[40%] bg-blue-800 text-white flex flex-col px-8 py-5 rounded-xl'>
            ...
            <div className='mt-auto px-4 py-4 bg-blue-950 text-white flex flex-col rounded-xl'>
